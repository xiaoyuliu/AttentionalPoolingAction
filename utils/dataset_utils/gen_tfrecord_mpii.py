...
_MPII_MAT_FILE = '../../src/datasets/mpii_human_pose_v1_u12_2/mpii_human_pose_v1_u12_1.mat'
_IMG_DIR = '../../src/datasets/images/'
...
def main():
    ...
    # give every image id a label for train/val/test
    for spl in splits:
